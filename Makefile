...
TARGET = mux.v mux_5.v mux_32.v or_32_input.v ALU_logical_1_bit.v ALU_logical_32.v sll_32.v srl_sra_32.v ALU_logical.v 1bit\ Adder.v 32bit\ Adder.v Set_operations.v alu_arith.v alu.v register.v register_file.v extender.v memory.v datapath.v fetch.v control_signal.v
